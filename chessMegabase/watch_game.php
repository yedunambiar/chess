        ...
        <div class="container" style="padding-top: 20px">
            ...
            <div class="col-xs-6">
                <table class="table table-striped scrollbar table-wrapper-scroll-y">
                    ...
                    $select_game_query = "SELECT game.id,game.gameDate,p1.name as white_player,p2.name as black_player,event.name as ename,site.name as sname,result.description,result.notation FROM game INNER JOIN player p1 ON game.player1=p1.id INNER JOIN player p2 ON game.player2=p2.id INNER JOIN event ON game.event_id=event.id INNER JOIN site ON game.site_id=site.id INNER JOIN result ON game.result_id=result.id WHERE game.id='$gameid'";
